...
import xyz.skullition.testmodfabric.entity.*;

public class ThingEntityModel extends EntityModel<ThingEntity> {
    private final ModelPart base;

    public ThingEntityModel(ModelPart modelPart) {
    ...
    @Override
    public void setAngles(ThingEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
    }
